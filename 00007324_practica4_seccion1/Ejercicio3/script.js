...
function calcularDiasCrecimiento (VelocidadCrecimiento, VelocidadDecremiento, alturaDeseada){
    let altura = 0;
    let dias = 0;
    while (altura < alturaDeseada){
        ...
        altura -= VelocidadDecremiento;
    }
    return dias;
}

console.log(calcularDiasCrecimiento(2,1,15));